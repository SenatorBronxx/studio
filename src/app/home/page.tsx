...
export default function HomePage() {
  ...
  const panelSpring = useSpring({
    transform: isPanelMinimized ? 'translateY(80%)' : 'translateY(0%)',
  ...
  return (
    <div className="relative flex flex-col min-h-screen w-full bg-background font-sans overflow-hidden">
      ...
      <div className="fixed bottom-0 left-0 right-0 z-20">
        <animated.div style={panelSpring} className="max-w-md mx-auto">
            <div
                className="p-2 sm:p-4"
                onTouchStart={(e) => e.stopPropagation()} // Prevent map interaction
            >
                <div 
                    className="bg-background/75 backdrop-blur-sm rounded-t-2xl p-4 flex flex-col gap-4 shadow-lg"
                >
                    <div 
